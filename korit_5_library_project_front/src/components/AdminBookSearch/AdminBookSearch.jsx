...
import { deleteBookRequest, getBookCountRequest, searchBooksRequest } from "../../apis/api/bookApi";
...
function AdminBookSearch({ selectStyle, bookTypeOptions, categoryOptions, isDelete, setDelete }) {
    ...
    const deleteBooksMutation = useMutation({
        mutationKey: "deleteBo   oksMutation",
    ...
    useEffect(() =>  {
        if(isDelete) {
            ...
            deleteBooksMutation.mutate(deleteBooks); // 삭제 요청이 날라감.
